 ...
 */
final class Version20200310230159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(60) NOT NULL, nom VARCHAR(60) NOT NULL, prix INT NOT NULL, description LONGTEXT NOT NULL, lien_image LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD date_naissance DATE DEFAULT NULL, ADD date_inscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP date_naissance, DROP date_inscription');
    }
}
